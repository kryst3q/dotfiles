...
local config = {
  cmd = {
    ...
    "-javaagent:" .. home .. "/.config/local/share/lvim/mason/packages/jdtls/lombok.jar",
    "-jar",
    vim.fn.glob(home .. "/.config/local/share/lvim/mason/packages/jdtls/plugins/org.eclipse.equinox.launcher_*.jar"),
    "-configuration",
    home .. "/.config/local/share/lvim/mason/packages/jdtls/config_" .. os_config,
    "-data",
    workspace_dir,
  },
